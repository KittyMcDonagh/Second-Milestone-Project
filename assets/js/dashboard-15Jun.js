$(document).ready(function() {
    ...
    $("#lodgings-link").click(function() {
        ...
        // Render the Lodging Types Chart . . .

        console.log("lodgings");

        queue()
            .defer(d3.json, "/assets/data/lodgings.json")
            .await(lodgingGraphs);

        function lodgingGraphs(error, transactionsData) {

            console.log("lodgingsGraphs");
    ...
    $("#safari-link").click(function() {
        ...
        function safariGraphs(error, transactionsData) {
            ...
            var safaris_dim = ndx.dimension(dc.pluck('activities'));
            var total_per_safari = activities_dim.group().reduceSum(dc.pluck('safari_count'));
            dc.pieChart('#trip-filter')
                .height(400)
                .radius(90)
                .transitionDuration(1500)
