...
function checkUserInput() {
    ...
    $("#lodgings-link").click(function() {
        ...
        // Clear user message, and collapsed menu if relevant (mobile phones)
...
// User has clicked on a link - first clear collapsed menu (on mobile phones), and clear the user message
function clearUserMesg() {

    // First close down the collapsible menu, if open - this code found with help from Slack and Stack Overflow
